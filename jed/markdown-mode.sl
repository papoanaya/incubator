...
variable markdown_mode_version = "1.8.1";
variable markdown_output_buffer_name = "*markdown-output*";

%%% Customizable variables ====================================================


variable markdown_hr_string = "* * * * *";
...
(defun markdown-unfontify-region-wiki-links (from to)
  ...
  (if (featurep 'emacs)
    ...
    (progn 
      (setq overlay-list (overlays-in from to))
      (when overlay-list
